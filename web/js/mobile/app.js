 ...
 */
import { api } from '../api.js?v=2.4.71';
import { state } from '../state.js?v=2.4.71';
import { renderDashboard } from './views/dashboard.js?v=2.4.71';
import { renderAgentDetail } from './views/agent-detail.js?v=2.4.71';
import { renderStartAgent } from './views/start-agent.js?v=2.4.71';
import { renderSettings } from './settings.js?v=2.4.71';
import { readRelayConfig, hasRelayConfig } from './settings-relay.js?v=2.4.71';
import { renderFileBrowser, renderAgentFileBrowser } from './views/file-browser.js?v=2.4.71';
import { renderNodes } from './nodes-page.js?v=2.4.71';
import { renderSkills } from './skills.js?v=2.4.71';
import { renderTodos } from './todos.js?v=2.4.71';
import { renderAgentSettings } from './agent-settings.js?v=2.4.71';
import { maybeInitDirectMode } from './direct-init.js?v=2.4.71';
import { installMobileCamBridgeShim } from './mobile-bridge.js?v=2.4.71';
import { refreshHubCapabilities, setHubCapabilities, HUB_CAP_FULL } from '../shared/hub-capabilities.js?v=2.4.71';
import { loadAgentFilters } from '../shared/agent-filters.js?v=2.4.71';
import { applyMobileAppearance } from '../shared/mobile-appearance.js?v=2.4.71';
import { filterAgentsOnEnabledHosts } from '../shared/node-host-meta.js?v=2.4.71';
