...
const PRECACHE = [
  ...
  '/js/api.js?v=60',
  '/js/state.js?v=60',
  '/js/views/dashboard.js?v=60',
  '/js/views/agent-detail.js?v=60',
  '/js/views/start-agent.js?v=60',
  '/js/views/contexts.js?v=60',
  '/js/views/settings.js?v=60',
  '/js/views/file-browser.js?v=60',
  '/css/style.css?v=60',
];
