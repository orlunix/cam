...
const PRECACHE = [
  ...
  '/js/api.js?v=55',
  '/js/state.js?v=55',
  '/js/views/dashboard.js?v=55',
  '/js/views/agent-detail.js?v=55',
  '/js/views/start-agent.js?v=55',
  '/js/views/contexts.js?v=55',
  '/js/views/settings.js?v=55',
  '/js/views/file-browser.js?v=55',
  '/css/style.css?v=55',
];
