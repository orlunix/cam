...
const PRECACHE = [
  ...
  '/js/api.js?v=59',
  '/js/state.js?v=59',
  '/js/views/dashboard.js?v=59',
  '/js/views/agent-detail.js?v=59',
  '/js/views/start-agent.js?v=59',
  '/js/views/contexts.js?v=59',
  '/js/views/settings.js?v=59',
  '/js/views/file-browser.js?v=59',
  '/css/style.css?v=59',
];
