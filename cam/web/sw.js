...
const PRECACHE = [
  ...
  '/js/api.js?v=54',
  '/js/state.js?v=54',
  '/js/views/dashboard.js?v=54',
  '/js/views/agent-detail.js?v=54',
  '/js/views/start-agent.js?v=54',
  '/js/views/contexts.js?v=54',
  '/js/views/settings.js?v=54',
  '/js/views/file-browser.js?v=54',
  '/css/style.css?v=54',
];
